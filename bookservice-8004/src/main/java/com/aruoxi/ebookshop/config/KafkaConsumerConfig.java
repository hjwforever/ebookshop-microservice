...
public class KafkaConsumerConfig {
	...
	@Bean
	public ConsumerFactory<String, Long> consumerConfig() {
	...
	public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, Long>> kafkaListenerContainerFactory() {
		ConcurrentKafkaListenerContainerFactory<String, Long> listener = new ConcurrentKafkaListenerContainerFactory<>();
